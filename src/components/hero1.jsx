...
export default function Hero() {
  ...
  return (
    <section className="relative lg:pt-0 sm:pt-36 pb-20 lg:pb-28 bg-gray-100/40 overflow-hidden">
        ...
        <div className="relative flex flex-col lg:block">
          ...
          <AnimatePresence>
            ...
            >
              ...
              <h2 className="sm:text-black xs:text-black lg:text-white text-3xl font-bold  font-gotham sm:text-4xl lg:text-6xl leading-tight mb-4 text-center lg:text-center">
